        ...
        <section style={{
            ...
            <footer className="footer p-10">
                <div>
                    ...
                    <p>Medico Healer Ltd.<br />Providing reliable medical service since 1992</p>
                </div>
                <div>
                    <span className="footer-title">Services</span>
                    <a className="link link-hover">Teeth Treatment</a>
                    <a className="link link-hover">Open Heart Surgery</a>
                    <a className="link link-hover">Emergency Unit</a>
                    <a className="link link-hover">Full Body Check Up</a>
                </div>
                <div>
                    <span className="footer-title">Locations</span>
                    <a className="link link-hover">Dhaka</a>
                    <a className="link link-hover">Chittagong</a>
                    <a className="link link-hover">Jamalpur</a>
                    <a className="link link-hover">Bandarbar</a>
            ...
            <footer className="footer items-center p-4 bg-neutral text-neutral-content">
                <div className="items-center grid-flow-col">
                    ...
                    <p>© {year} Developed by Arnob Tarafder - All right reserved</p>
                </div>
